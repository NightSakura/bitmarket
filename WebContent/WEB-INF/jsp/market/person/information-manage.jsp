		...
		<div class="col-main">
			<div class="main-wrap">
				...
				<div class="user-info">
						...
						<div class="info-m">
							...
							<div class="u-level">
								<span class="rank r2"> <s class="vip1"></s><a
									class="classes" href="#">${userLevel} }</a>
								</span>
							</div>
							<div class="u-safety">
								<a href="safety.html"> 账户安全 <span class="u-profile"><i
										class="bc_ee0000" style="width: 60px;" width="0">${userMarl}</i></span>
								</a>
							</div>
						</div>
					</div>
					...
					<!--个人信息 -->
					<div class="info-main">
						<form class="am-form am-form-horizontal" action="/person/infoMain">
							...
							<div class="am-form-group">
								...
								<div class="am-form-content">
									<input type="text" id="real-name" placeholder="name">
